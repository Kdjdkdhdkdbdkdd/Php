...
[["text" =>"𖠜 Add Delete ⤻ Number"],["text" =>"𖠜 Add Delete ⤻ User"]],
[["text" =>"𖠜 Run ⤻ StoP"]],
[["text" =>"𖠜 Clear List"],["text" =>"𖠜 Show List"]],
[["text" =>"𖠜 Pin All"]],
[["text" =>"𖠜 Rest Checker"],["text" =>"⤷ Update Checker"]],
[["text" =>"𖠜 Clicks"],["text" =>"𖠜 Status PM2"]],
[["text" =>"𖠜 Status Type"]],  
[["text" =>"𖠜 Ping"]], 
[["text" =>"𖠜 StoP Ali"],["text" =>"𖠜 Run Ali"]],] ]) ]);
}
}
...
if($text == "⤷ Update The Fishing"){
	...
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Botvenom/blob/main/1.php");
	file_put_contents("2.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Botvenom/blob/main/2.php");
	file_put_contents("3.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Botvenom/blob/main/3.php");
	file_put_contents("4.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Botvenom/blob/main/4.php");
	file_put_contents("5.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Botvenom/blob/main/5.php");
	file_put_contents("6.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Botvenom/blob/main/6.php");
	file_put_contents(",7.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Botvenom/blob/main/7.php");
	file_put_contents("8.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Botvenom/blob/main/8.php");
	file_put_contents("9.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Botvenom/blob/main/9.php");
	file_put_contents("10.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Botvenom/blob/main/10.php");
	shell_exec("pm2 stop 1.php");
	shell_exec("pm2 stop 2.php");
	shell_exec("pm2 stop 3.php");
	shell_exec("pm2 stop 4.php");
...
if($text == "⤷ Update Madeline"){
	...
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Botvenom/blob/main/madeline.php");
...
if($text == "⤷ Update The Bot"){
	...
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Botvenom/blob/main/bot.php");
